        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <i class="menu-icon tf-icons bx bx-dock-top"></i>
                        <div data-i18n="Basic">입고 관리</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="html/pages-account-settings-account.html" class="menu-link">
                                <div data-i18n="Account">입고 요청 조회/승인</div>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <i class="menu-icon tf-icons bx bx-dock-top"></i>
                        <div data-i18n="Basic">출고 관리</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="html/pages-account-settings-account.html" class="menu-link">
                                <div data-i18n="Account">출고지시서 조회/승인</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="html/pages-account-settings-account.html" class="menu-link">
                                <div data-i18n="Account">운송장 등록/조회</div>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <i class="menu-icon tf-icons bx bx-dock-top"></i>
                        <div data-i18n="Basic">재무 관리</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="html/pages-account-settings-account.html" class="menu-link">
                                <div data-i18n="Account">지출 관리</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="html/pages-account-settings-account.html" class="menu-link">
                                <div data-i18n="Account">매출 관리</div>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <i class="menu-icon tf-icons bx bx-dock-top"></i>
                        <div data-i18n="Basic">거래처 관리</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="html/pages-account-settings-account.html" class="menu-link">
                                <div data-i18n="Account">거래처 조회</div>
                            </a>
                        </li>
                    </ul>
                </li>
...
<!-- admin-manager-member-header.jsp End -->

<%-- 컨텐츠 추가할 때 컨텐츠 시작 태그부터 넣으면 됨 --%>